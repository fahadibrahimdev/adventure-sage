...
<template>
  <div class="fixed top-0 left-1/2 transform -translate-x-1/2 pt-3 sm:pt-5 z-30 w-[95%] sm:w-[90%] mx-auto">
    <nav class="nav-bar bg-[#0C5F5E] rounded-6xl px-3 md:px-0 py-3 lg:py-3 xl:py-4 z-50 w-full">
      <div class="container flex justify-between items-center">
        <!-- Brand Logo -->
        <div class="brand-logo w-24 lg:w-32 2xl:w-36">
          <RouterLink to="/">
          ...
          <ul class="nav-links md:space-x-14 xl:space-x-24 3xl:space-x-38 md:flex lg:text-xl xl:text-2xl 3xl:text-3xl text-accent">
            <template v-for="(navLink, i) in menuNavLinks" :key="i">
              <li
                  ...
                  :class="{ 'font-bold text-white': currentSection === navLink.sectionId }"
